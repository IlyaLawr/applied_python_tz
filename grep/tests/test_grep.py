...
class GrepBaseTest(unittest.TestCase):
...
class GrepPatternTest(unittest.TestCase):
...
class GrepContextTest(unittest.TestCase):
...
class GrepLineNumbersTest(unittest.TestCase):
